...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "demo-service-weaver/Reverser",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "demo-service-weaver/Reverser", Method: "Reverse"})}
		},
